...
module.exports=function(modelo){
    return {
        ...
        registro:function(peticion,respuesta){
            modelo.sequelize.query("CALL sp_registroUsuario('"+peticion.body.nombre+"','"+peticion.body.correo+"','"+peticion.body.nick+"','"+peticion.body.contraseña+"','"+peticion.body.direccion+"','"+peticion.body.telefono+"','"+peticion.body.id_Rol+"');")
                .then(function(){
